        ...
        <TabsContent value="aumento">
          <Card><CardContent className="p-4">
            ...
            <p>
              ...
              de demanda. O valor do cálculo de demanda é de R$ 1.000,00, com prazo de entrega de até 30 dias
              e validade de 30 dias. O projeto completo custa R$ 1.900,00. Para prédios, o projeto completo
              com elétrica e telecomunicações, incluindo medição com barramento e levantamento de carga dos pavimentos
              inferiores, custa R$ 3.400,00.
            </p>
          </CardContent></Card>
        </TabsContent>
